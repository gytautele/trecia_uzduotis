...
int main ()
{
        ...
        for (int i=0; i<m; i++) {
            ...
            if (a==1) {
                ...
                else duomenys[i].med=(double)(duomenys[i].nd[(duomenys[i].paz_sk-1)/2] + duomenys[i].nd[duomenys[i].paz_sk/2])/2.0;
        ...
        for (int i=0; i<m; i++)
        {
            ...
            cout << duomenys[i].pavarde << std::right << setw(20) << duomenys[i].vardas << std::right << setw(20) << std::fixed << std::setprecision(2) << std::right << duomenys[i].galutinis1 << setw(20) << std::right << duomenys[i].galutinis2 << endl;
        }
